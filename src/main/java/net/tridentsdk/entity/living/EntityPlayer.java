 ...
 */
@ThreadSafe
public interface EntityPlayer extends EntityLiving, CommandSource {
    /**
     ...
     */
    @Nullable
    static EntityPlayer byName(String name) {
     ...
     */
    @Nonnull
    static Map<String, EntityPlayer> search(String search) {
